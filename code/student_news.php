...
FROM Article
WHERE audience IN ('public', 'student') 
...
<div id="background">
  ...
  <div id="bond">
    ...
    <div id="body">
      <h1>Staff News</h1>
      <a style='float: left;' href="student_news.php?offset=<?= $offset - 4 ?>">prev</a>
      <a style='float: right;' href="student_news.php?offset=<?= $offset + 4 ?>">next</a>
      <br>
      <br>
